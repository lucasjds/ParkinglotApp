...
{
  public class CarroEnricher : ContentResponseEnricher<CarroVO>
  {
    private readonly object _lock = new object();
    protected override Task EnrichModel(CarroVO content, IUrlHelper urlHelper)
    {
      var path = "api/carro/v1";
